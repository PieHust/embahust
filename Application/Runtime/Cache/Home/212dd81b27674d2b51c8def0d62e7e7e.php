...
<body>
	...
	<div class="top-pic">
		<img src="/embahust/Public/home/image/tea.jpg" style="width: 980px;height: 200px;" />
	</div>
	...
	<div class="main-content">
		<h2 style="font-weight:bolder;"><?php echo ($arr['name']); ?></h2>
		<!-- <div style="width:200px;height:190px;margin:0 auto;">
			<img src=<?="/embahust".substr($arr['picture'], 1)?> style="width:200px;margin:0 auto;">
		</div> -->
		<div><?php echo ($arr['info']); ?></div>
